"""Application configuration for Tool Calling Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="tool-calling-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/tool_calling_agent",
    ...
    opensearch_index: str = Field(default="tool_calling_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="tool-calling-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="tool-calling-agent", description="A2A agent ID")
